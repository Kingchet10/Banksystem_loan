      ...
      <div class="dialog-content">
        <el-form :model="selectedLoan" label-position="top" label-width="120px" class="loan-form">
          ...
          <el-form-item label="个人情况声明(Personal Statement)">
            <el-input type="textarea" :autosize="{ minRows: 7, maxRows: 14 }" v-model="selectedLoan.statement" disabled />
          </el-form-item>
        </el-form>
      </div>
...
export default {
  ...
  setup() {
    ...
    return {
      loans, dialogVisible, approvalDialogVisible, creditDialogVisible, selectedLoan, selectedCredit, fetchLoans, viewLoanDetails, openApprovalDialog, approveLoan, rejectLoan, viewCreditReport, handlePageChange, currentPage, pageSize, totalLoans
    };
  },
