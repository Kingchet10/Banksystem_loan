      ...
      <el-table :data="approvals" style="width: 100%" class="approval-table" header-align="center" align="center">
        ...
        <el-table-column label="操作" width="150">
          <template #default="scope">
            <el-button type="primary" size="small" @click="viewApprovalDetails(scope.row)" class="view-button">查看详情</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import { ref } from 'vue';
import { ElTable, ElTableColumn, ElDialog, ElButton, ElForm, ElFormItem, ElInput } from 'element-plus';
